                          ...
                          <table id="tablaSolicitudes" class="table table-bordered table-hover">
                              ...
                              <tbody id="table_trabajador_data">
                                  ...
                                  <?php
                                    ...
                                    $query = "SELECT solicitud.idsolicitud,solicitud.titulo,concat(m_trabajador.t_apelllido,', ',m_trabajador.t_nombre) as nombre,maquina.nombre,lugar.nombre,date(fecha),time(fecha)
